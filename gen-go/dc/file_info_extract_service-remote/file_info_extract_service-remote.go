...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  bool uploadFile(FileData filedata)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := dc.NewFileInfoExtractServiceClient(thrift.NewTStandardClient(iprot, oprot))
